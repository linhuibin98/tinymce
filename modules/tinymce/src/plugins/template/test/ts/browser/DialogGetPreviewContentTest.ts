...
const noCorsNoStyle = '<!DOCTYPE html><html><head><base href="http://localhost:8000/"><link type="text/css" rel="stylesheet" href="http://localhost:8000/project/tinymce/js/tinymce/skins/ui/oxide/content.min.css"><link type="text/css" rel="stylesheet" href="http://localhost:8000/project/tinymce/js/tinymce/skins/content/default/content.css"><script>document.addEventListener && document.addEventListener("click", function(e) {for (var elm = e.target; elm; elm = elm.parentNode) {if (elm.nodeName === "A" && !(' + metaKey + ')) {e.preventDefault();}}}, false);</script> </head><body class=""></body></html>';

const CorsNoStyle = '<!DOCTYPE html><html><head><base href=\"http://localhost:8000/\"><link type=\"text/css\" rel=\"stylesheet\" href=\"http://localhost:8000/project/tinymce/js/tinymce/skins/ui/oxide/content.min.css\" crossorigin=\"anonymous\"><link type=\"text/css\" rel=\"stylesheet\" href=\"http://localhost:8000/project/tinymce/js/tinymce/skins/content/default/content.css\" crossorigin=\"anonymous\"><script>document.addEventListener && document.addEventListener(\"click\", function(e) {for (var elm = e.target; elm; elm = elm.parentNode) {if (elm.nodeName === \"A\" && !(' + metaKey + ')) {e.preventDefault();}}}, false);</script> </head><body class=\"\"></body></html>';
...
const CorsStyleAndContent = '<!DOCTYPE html><html><head><base href=\"http://localhost:8000/\"><style type=\"text/css\">This is the style inserted into the document</style><link type=\"text/css\" rel=\"stylesheet\" href=\"http://localhost:8000/project/tinymce/js/tinymce/skins/ui/oxide/content.min.css\" crossorigin=\"anonymous\"><link type=\"text/css\" rel=\"stylesheet\" href=\"http://localhost:8000/project/tinymce/js/tinymce/skins/content/default/content.css\" crossorigin=\"anonymous\"><script>document.addEventListener && document.addEventListener(\"click\", function(e) {for (var elm = e.target; elm; elm = elm.parentNode) {if (elm.nodeName === \"A\" && !(' + metaKey + ')) {e.preventDefault();}}}, false);</script> </head><body class=\"\">Custom content which was provided</body></html>';
